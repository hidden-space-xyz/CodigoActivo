...
import { useOrganizationContent } from '@/modules/about/presentation/composables/useOrganizationContent'
import ValueCard from '@/modules/about/presentation/components/ValueCard.vue'
    ...
    <div class="ca-container about-preview__grid">
      <div>
        ...
        <p class="about-preview__text">
          ...
          programar abre puertas. Organizamos talleres, campeonatos y eventos gratuitos en entornos
          rurales y urbanos.
        </p>
        <BaseButton :to="{ name: 'about' }" variant="purple" class="about-preview__cta">
          Sobre la asociación →
        </BaseButton>
      </div>

      <div class="about-preview__values">
        <ValueCard v-for="value in values" :key="value.id" :value="value" size="sm" />
      </div>
    </div>
  </section>
</template>
