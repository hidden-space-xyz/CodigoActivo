...
export const ErrorCode = {
  ...
  UserBirthDateNotAllowedForAdult: 'UserBirthDateNotAllowedForAdult',
  UserChildBirthDateRequired: 'UserChildBirthDateRequired',
  ...
  UserNationalIdAlreadyInUse: 'UserNationalIdAlreadyInUse',
  ...
  RegisterNationalIdAlreadyInUse: 'RegisterNationalIdAlreadyInUse',
  ...
  TwoFactorCodeInvalid: 'TwoFactorCodeInvalid',
  TwoFactorLocked: 'TwoFactorLocked',
  TwoFactorChallengeExpired: 'TwoFactorChallengeExpired',
  TwoFactorResendNotAllowed: 'TwoFactorResendNotAllowed',
  TwoFactorResendCooldownActive: 'TwoFactorResendCooldownActive',
  AuthenticatorSetupExpired: 'AuthenticatorSetupExpired',
  AuthenticatorNotEnabled: 'AuthenticatorNotEnabled',
