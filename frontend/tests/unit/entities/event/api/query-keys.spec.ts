...
describe('eventQueryKeys', () => {
  it('nests every event key under the events root', () => {
    ...
    expect(eventQueryKeys.leaderRoster('e1', 'u1')).toEqual(['events', 'leader-roster', 'e1', 'u1'])
    expect(eventQueryKeys.leaderRoster('e1', null)).toEqual(['events', 'leader-roster', 'e1', null])
